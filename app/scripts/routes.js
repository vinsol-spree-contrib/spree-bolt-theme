...
function renderTemplate() {
  ...
  switch(path) {
    ...
    case 'category_products':
      new SpreeApi.productsList('https://spree-theme.herokuapp.com/').sendRequest({cb: renderCategoryProductsPage, params: { q: { taxons_id_eq: category_id }, per_page: 8, page: getUrlParameter('page') }});
      break;
    case 'cart':
